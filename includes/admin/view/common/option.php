...
<nav class="nav-tab-wrapper woo-nav-tab-wrapper">
	<a href="<?php admin_url('edit.php');  ?>?post_type=<?php echo CF_CALENDAR ?>&page=common-settings" class="nav-tab"><?php _e('Schedule & Holiday Settings', CFC_TEXTDOMAIN); ?></a>
	...
	<a href="<?php admin_url('edit.php');  ?>?post_type=<?php echo CF_CALENDAR ?>&page=common-settings&tab=option" class="nav-tab nav-tab-active"><?php _e('Other Settings', CFC_TEXTDOMAIN); ?></a>
</nav>
